...
class TopNav extends Component {
  ...
  render() {
    const loggedInUserData = loggedInUser.getProfile().user;
    const user_lname = loggedInUserData.user_lname;
    const user_fname = loggedInUserData.user_fname;
    const photo = loggedInUserData.photo;

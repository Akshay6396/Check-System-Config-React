...
import { alignSingleCaseKam } from "../../../redux/actions";
...
class KamAlignSingalModal extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidUpdate() {
    ...
    if (this.props.casesApp.alignKamSuccess) {
      NotificationManager.success(
        this.props.casesApp.alignKamSuccess,
        "Success",
        3000,
        null,
        null,
  ...
  onSubmit = () => {
    ...
    if (confirmation == true) {
      ...
      this.props.alignSingleCaseKam(newItem, this.props);
    }
  };
  render() {

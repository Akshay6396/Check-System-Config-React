...
import {
  addPendingFitmentSchools,
  getStageHistoryData,
  getCountryName,getSchoolsMaster
} from "../../../redux/actions";
...
// For drop image end
class PendingFitmentCompleteModal extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidUpdate = prevProps => {
    if (
      ...
      // this.getHistory();
      this.props.getSchoolsMaster();

    }
    if (this.props.casesApp.submitaddfitmentSuccess) {
      NotificationManager.success(
        this.props.casesApp.caseAddSuccess,
        "Success",
        3000,
        null,
        null,
      ...
      this.props.casesApp.submitaddfitmentSuccess = "";
    }
  };
  getHistory = () => {
    let payload = {
  ...
  onSubmit = () => {
    ...
    this.props.addPendingFitmentSchools(newItem, this.props);
  };
  ...
  render() {
    ...
    const { schoolsMaster } = this.props.casesApp;
    return (
      <Modal
        size="xl"
        isOpen={modalOpen}
      ...
      >
        <ModalHeader toggle={toggleModal}>Schools Shortlisting</ModalHeader>
        <ModalBody>
          {/* <FitmentComments /> */}
        ...
        <ModalFooter>
          {/* <Button
            ...
            className={`btn-shadow  btn-multiple-state ${
              this.props.casesApp.loading ? "show-spinner" : ""
              }`}

...
import { submitPsychometricTest, getStageHistoryData } from "../../../redux/actions";
...
// For drop image end
class PsychometricTestModal extends Component {
  constructor(props) {
    super(props);
  ...
  onsubmitPsychometricTest = () => {
    ...
    this.props.submitPsychometricTest(newItem, this.props);
  };
  render() {
    ...
    return (
      <Modal
        ...
        backdrop="static"
      >
        <ModalHeader toggle={toggleModal}>Complete Psycometeric Test</ModalHeader>
        <ModalBody>
          <Fragment>
        ...
        <ModalFooter>
          <Button
            ...
            color="primary" onClick={this.onsubmitPsychometricTest}>

...
// For drop image end
class SchoolFitmentModal extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidUpdate = prevProps => {
    ...
    if (this.props.studentApp.submitSchoolFitmentSuccess) {
      ...
      this.props.studentApp.submitSchoolFitmentSuccess = "";
    }
  };
  getHistory = () => {
    let payload = {
  ...
  onSubmit = () => {
    ...
    this.props.submitSchoolFitment(newItem, this.props);
  };
  onComplete = () => {
    const newItem = {
      user_id: this.state.user_id,
    ...
    this.props.completeSchoolFitment(newItem, this.props);
  };
  render() {
    const eventHandlers = {

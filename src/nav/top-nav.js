...
const Topnav = props => {
    return (
        <nav className="navbar navbar-expand-lg  sticky-top">
            <div className="container"><a href="https://leverageedu.com/" className="navbar-brand">
                ...
                <div className="collapse navbar-collapse" id="globalNavbar">
                    ...
                    <ul className="navbar-nav d-none d-lg-flex ml-2 order-3">
                        <li className="nav-item"><a href="https://leverageedu.com/" target="_blank" className="nav-link" >Home</a></li>
                        <li className="nav-item"><a href="https://leverageedu.com/search" target="_blank" className="nav-link" >Discover</a></li>
                        ...
                        <li className="nav-item dropdown show">
                            ...
                            <div className="dropdown-menu show">
                                <a className="dropdown-item" href="https://leverageedu.com/for-school" target="_blank">
                                    <img alt="" src={require('../assets/img/icons/for-school.svg')} /> For School Students
                                </a>
                                <a className="dropdown-item" href="https://leverageedu.com/for-college" target="_blank">
                                    <img alt="" src={require('../assets/img/icons/for-college.svg')} /> For University Students
                                </a>
                                <a className="dropdown-item" href="https://leverageedu.com/for-professionals" target="_blank">
                                    <img alt="" src={require('../assets/img/icons/for-professional.svg')} /> For Working Professionals
                                </a>
                            </div>
                        </li>

                        <li className="nav-item"><a href="https://leverageedu.com/blog/" target="_blank" className="nav-link" >Blog</a></li>
